...
namespace MenuPresentationModel.MenuStyles
{
    ...
    public class HeadingAccent : MarshalByRefObject,  IHeadingAccent, OOAdvantech.PersistenceLayer.IObjectStateEventsConsumer
    {
        ...
        /// <exclude>Excluded</exclude>
        System.Collections.Generic.List<Resource> _AccentImages = new System.Collections.Generic.List<Resource>();
        ...
        /// <MetaDataID>{08730a4f-d573-42f1-9ff7-c2af787f9204}</MetaDataID>
        string _Name;
