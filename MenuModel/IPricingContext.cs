...
namespace MenuModel
{
    ...
    public interface IPricingContext
    {
        ...
        string Name { get; set; }
        [Association("CustomazedPrice", Roles.RoleA, "30caadeb-0046-4f1b-9cc7-00d19a96b4a4")]
        ...
        void RemoveCustomazedPrice(ICustomizedPrice customazedPrice);


        /// <MetaDataID>{94dc1543-7310-4ce6-b528-92dd09cde403}</MetaDataID>
        ICustomizedPrice GetCustomazedPrice(IPricedSubject pricedSubject);
