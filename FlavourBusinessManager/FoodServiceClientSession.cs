...
namespace FlavourBusinessManager.EndUsers
{
    ...
    public class FoodServiceClientSession : MarshalByRefObject, IFoodServiceClientSession, OOAdvantech.Remoting.IExtMarshalByRefObject, OOAdvantech.PersistenceLayer.IObjectStateEventsConsumer, FinanceFacade.IPaymentGateway
    {
        ...
        public ClientSessionData ClientSessionData
        {
            get
            {
                ...
                if (ServicePoint is IHomeDeliveryServicePoint)
                    return new ClientSessionData() { ServicesContextLogo = ServicePoint.Description, SessionID = this.SessionID, ServicesPointName = "", SessionType = SessionType, ServicePointIdentity = ServicePoint.ServicesContextIdentity + ";" + ServicePoint.ServicesPointIdentity, Token = ServicesContextRunTime.GetToken(this), FoodServiceClientSession = this, Menu = Menu, ServedMealTypesUris = servedMealTypesUris, DefaultMealTypeUri = defaultMealTypeUri, ServicePointState = ServicePoint.State, UserLanguageCode = UserLanguageCode, DeliveryPlace = GetSessionDeliveryPlace(), PriceList = PriceList };
                else
                    return new ClientSessionData() { ServicesContextLogo = "Pizza Hut", SessionID = this.SessionID, ServicesPointName = ServicePoint.Description, SessionType = SessionType, ServicePointIdentity = ServicePoint.ServicesContextIdentity + ";" + ServicePoint.ServicesPointIdentity, Token = ServicesContextRunTime.GetToken(this), FoodServiceClientSession = this, Menu = Menu, ServedMealTypesUris = servedMealTypesUris, DefaultMealTypeUri = defaultMealTypeUri, ServicePointState = ServicePoint.State, UserLanguageCode = UserLanguageCode, DeliveryPlace = GetSessionDeliveryPlace(), PriceList = PriceList };
        ...
        /// <MetaDataID>{11c99024-89af-41a5-b7cc-e0bcaddcbfbe}</MetaDataID>
        ...
        public void RemoveItem(IItemPreparation item)
        {
            ...
            if (sharedFlavourItem != null)
            {
                using (ObjectStateTransition stateTransition = new ObjectStateTransition(this))
                {
                    _SharedItems.Remove(sharedFlavourItem);
                    stateTransition.Consistent = true;
                }
        ...
        /// <MetaDataID>{d0c50afe-b00c-4562-b6d5-0c24fca9f0f1}</MetaDataID>
        ...
        /// <MetaDataID>{56eed0de-b662-4715-96a2-32e94f23f6fa}</MetaDataID>
        ...
        /// <MetaDataID>{296a0924-6e52-449c-bcee-7fbd9b4bbdd0}</MetaDataID>
    ...
    {
        /// <MetaDataID>{6a635e72-d510-4370-a750-a3c5f51a7f8a}</MetaDataID>
        public Caregiver() { }
        ...
        /// <MetaDataID>{85943a54-ea11-4c60-a2bb-90c6cec37607}</MetaDataID>
        [OOAdvantech.Json.JsonProperty]
