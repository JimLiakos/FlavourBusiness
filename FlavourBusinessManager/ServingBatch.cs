...
namespace FlavourBusinessManager.RoomService
{
    ...
    public class ServingBatch : MarshalByRefObject, OOAdvantech.Remoting.IExtMarshalByRefObject,IServingBatch
    {
        ...
        public List<IItemPreparation> PreparedItems { get; set; }
        ...
        [CachingDataOnClientSide]
        public System.Collections.Generic.IList<FlavourBusinessFacade.RoomService.ItemsPreparationContext> ContextsOfPreparedItems { get; set; }
