...
namespace OOAdvantech.PersistenceLayer
{
    ...
    /// <MetaDataID>{a11e4371-6b02-43dd-a462-582d528001f2}</MetaDataID>
    ...
    public partial class StoragesClient
    {
        ...
        public System.Threading.Tasks.Task<StorageMetaData> GetAsync(string storageIdentity)
        {
        ...
        public async System.Threading.Tasks.Task<StorageMetaData> GetAsync(string storageIdentity, System.Threading.CancellationToken cancellationToken)
        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            ...
                            var result_ = default(StorageMetaData);
                            try
                            {
                                result_ = OOAdvantech.Json.JsonConvert.DeserializeObject<StorageMetaData>(responseData_, _settings.Value);
                                return result_;
                            }
                        ...
                        return default(StorageMetaData);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<string> PostAsync(StorageMetaData storageMetaData)
        {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<string> PostAsync(StorageMetaData storageMetaData, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Storages");
    ...
    /// <MetaDataID>{eaa28d65-c537-4351-b0fa-3c95e8276b5d}</MetaDataID>
