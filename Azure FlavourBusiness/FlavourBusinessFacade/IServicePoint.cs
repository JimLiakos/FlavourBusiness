...
namespace FlavourBusinessFacade.ServicesContextResources
{
    ...
    public interface IServicePoint
    {
        ...
        /// </returns>
        IFoodServiceClientSession GetFoodServiceClientSession(string clientName, string mealInvitationSessionID, string clientDeviceID, string deviceFirebaseToken,bool endUser, bool create = false);
