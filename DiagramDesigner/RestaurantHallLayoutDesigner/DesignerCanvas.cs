    ...
    public partial class DesignerCanvas : Canvas
    {
        ...
        protected override void OnDrop(DragEventArgs e)
        {
            ...
            if (dragObject != null && !String.IsNullOrEmpty(dragObject.Xaml))
            {
                ...
                {
                    var sourceUri = (content as SvgViewbox).Source;
                    content = new SvgHostControl();
                    (content as SvgHostControl).svgHost.Source = sourceUri;
                }
                if (content != null)
                {
                    //(content as SvgHostControl).HorizontalAlignment = HorizontalAlignment.Stretch;
                    //(content as SvgHostControl).VerticalAlignment =VerticalAlignment.Stretch;
