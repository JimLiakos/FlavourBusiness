...
namespace GreekTaxAuthority
{
    ...
    public static class TransactionEx
    {
        ...
        public static void SetIssueDate(this FinanceFacade.ITransaction tranasaction, DateTime issueDate)
        {
            tranasaction.SetPropertyValue("IssueDateTicks", issueDate.Ticks.ToString());
        }
        ...
        public static DateTime? GetIssueDate(this FinanceFacade.ITransaction tranasaction)
        {
            string value = tranasaction.GetPropertyValue("IssueDateTicks");
            if (value == null)
                return null;
            long issueDateTicks = 0;
            if (long.TryParse(value, out issueDateTicks))
                return new DateTime(issueDateTicks);
            else
                return null;
        }
