...
namespace FLBManager.ViewModel.Delivery
{
    ...
    public class DeliveryCallCenterStationPresentation : FBResourceTreeNode, IGraphicMenusOwner, INotifyPropertyChanged, IDragDropTarget
    {
        ...
        public string CallcenterStationIdentity
        {
            get
            {
                return HomeDeliveryCallCenterStation.CallcenterStationIdentity;
            }
            set
            {
            }
        ...
        HomeDeliveryServiceTreeNode HomeDeliveryServiceTreeNode;

        /// <MetaDataID>{dc68144e-838f-4acb-86ef-5b873c8733da}</MetaDataID>
        //internal DeliveryCallCenterStationsTreeNode DeliveryCallCenterStationsTreeNode;

        /// <MetaDataID>{95fbc99b-2b06-40de-b5f8-3931f2e4e983}</MetaDataID>
        public DeliveryCallCenterStationPresentation(HomeDeliveryServiceTreeNode parent, IHomeDeliveryCallCenterStation deliveryCallCenterStation ): base(parent)
        {


            // .ServicesContext.GetRunTime

            HomeDeliveryServiceTreeNode = parent;
            this.HomeDeliveryCallCenterStation = deliveryCallCenterStation;

            _Description=deliveryCallCenterStation.Description;
            ...
            {
                deliveryCallCenterStation.Description=_Description;
            ...
            EditCommand = new WPFUIElementObjectBind.RelayCommand((object sender) =>
        {
            ...
            string graphicMenuStorageIdentity = deliveryCallCenterStation?.GraphicMenuStorageIdentity;
        ...
        public DeliveryCallCenterStationPresentation() : base(null)
        {
        ...
        private void Delete()
        {
            //this.DeliveryCallCenterStationsTreeNode.RemoveDeliveryCallCenterStation(this);
            this.HomeDeliveryServiceTreeNode.RemoveDeliveryCallCenterStation(this);
        ...
        public override ImageSource TreeImage
        {
            get
            {
                return new BitmapImage(new Uri(@"pack://application:,,,/FLBManager;Component/Resources/Images/Metro/call-center16.png"));
            }
        }
        ...
        {
            this.HomeDeliveryCallCenterStation.GraphicMenuStorageIdentity=null;
