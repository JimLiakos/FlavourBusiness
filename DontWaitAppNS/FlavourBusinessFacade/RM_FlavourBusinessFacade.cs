...
public event FlavourBusinessFacade.EndUsers.MessageReceivedHandle MessageReceived
        ...
        public void PaymentUpdate(FinanceFacade.IPayment payment)
        {
            object[] args = new object[1];
            System.Type[] argsTypes = new System.Type[1];
            args[0] = payment;
            argsTypes[0] = typeof(FinanceFacade.IPayment);
            object retValue = this.Proxy.Invoke(typeof(FlavourBusinessFacade.EndUsers.IFoodServiceClientSession), "PaymentUpdate", args, argsTypes);
        }
