...
namespace MenuDesigner.ViewModel.PriceList
{
    ...
    public class PriceListsTreeNode : FBResourceTreeNode, IDragDropTarget
    {
            ...
            get
            {
                if (_ContextMenuItems == null)
                {
                    ...
                    if (PriceListOwner.NewPriceListAllowed)
                    {
                        ...
                        var imageSource = new BitmapImage(new Uri(@"pack://application:,,,/MenuDesignerLib;Component/Resources/Images/Metro/price-list16.png"));
        ...
        public override ImageSource TreeImage
        {
            get
            {
                return new BitmapImage(new Uri(@"pack://application:,,,/MenuDesignerLib;Component/Resources/Images/Metro/price-lists16.png"));
            }
        }
