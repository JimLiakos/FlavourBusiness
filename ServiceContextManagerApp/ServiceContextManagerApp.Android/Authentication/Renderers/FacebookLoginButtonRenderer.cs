    ...
    public class FacebookLoginButtonRenderer : ViewRenderer
    {
		...
		protected override void OnElementChanged(ElementChangedEventArgs<View> e)
		{
            if (Control == null)
            {
                ...
                fbLoginbBtnCtrl.RegisterCallback(ServiceContextManagerApp.Droid.MainActivity.CallbackManager, new MyFacebookCallback(this.Element as FacebookLoginButton));
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing && !this.disposed)
            {
                ...
                {
                    (this.Control as Xamarin.Facebook.Login.Widget.LoginButton).UnregisterCallback(ServiceContextManagerApp.Droid.MainActivity.CallbackManager);
