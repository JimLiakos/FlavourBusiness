...
namespace XFFacebookExample
{
    public class LoginViewModel
    {
        ...
        {
            facebookLoginService = (Application.Current as ServiceContextManagerApp.App).FacebookLoginService;
        ...
        void DisplayAlert(string title, string msg) =>
            (Application.Current as ServiceContextManagerApp.App).MainPage.DisplayAlert(title, msg, "OK");
    }
}
